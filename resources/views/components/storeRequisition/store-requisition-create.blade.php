...
<script>
    ...
    function addModalC(id,name, unitId, unit) {
    ...
    async function ProductList(){
        ...
        res.data.forEach(function (item,index) {
            let row=`<tr class="text-xs">
                    ...
                    <td> ${item['quantity']} ${item['unit_name']}</td>
                    <td><a data-name="${item['product_name']}" data-unit="${item['unit_name']}" data-id="${item['product_id']}" data-unitid="${item['unit_id']}" class="btn btn-outline-dark text-xxs px-2 py-1 addProductCre btn-sm m-0">Add</a></td>
                 </tr>`
