...
<div class="container-fluid">
    ...
    <div class="col-md-12 col-sm-12 col-lg-12">
        <div class="card px-5 py-5">
                ...
                <select class="form-control form-select" id="statusWiseReqRepID">
            ...
            <button onclick="StatusWiseRequsitionReport()" class="btn mt-3 bg-gradient-primary ">Show Report</button>
            </div>

            <div class="row justify-content-between ">
                <div class="align-items-center col">
                    <h4>Status Wise Requsition Report</h4>
                </div>
                <div class="align-items-center col">
...
<script>
     ...
     async function StatusWiseRequsitionReport() {

        //let id = document.getElementById('storeWiseRepID').value;
        let approveID = document.getElementById('statusWiseReqRepID').value;

        console.log(approveID);

        showLoader();
        let res = await axios.post('/status-wise-requsition-report',{is_approve: approveID},HeaderToken());
        hideLoader();
    ...
    async function DownloadReport(){
        let storeWiseIDDown = document.getElementById('statusWiseReqRepID').value;
            showLoader();
