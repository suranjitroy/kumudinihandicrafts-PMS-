    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">Product Receive</h6>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 p-1">
                                ...
                                <select type="text" class="form-control form-select" id="proRecID">
                            ...
                            <div class="col-12 p-1">
                                ...
                                <select type="text" class="form-control form-select" id="supplierID">
...
async function SupplierDropDownList(){
...
$('.calcutate').on('input', function(){
   ...
   async function Save(){
        ...
        let res = await axios.post('/create-product-receive',postBody,HeaderToken());
